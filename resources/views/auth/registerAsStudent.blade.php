            ...
            <div class="shopper-info">
                <div class="col-sm-12">
                    ...
                    <div class="contact-form">
                        <h2 class="title text-center">Зареєструватись як студент</h2>
                        <div class="status alert alert-success" style="display: none"></div>
                        <form method="POST" action="{{ route('add-student') }}">
                            @csrf
                            <div class="form-group col-md-12">
                                <label for="name">{{ __('Номер студентського') }}</label>
                                <input class="form-control" id="studnumber" type="text" class="form-control" name="studnumber" required autocomplete="student's number" autofocus>
                            </div>
                            <div class="form-group col-md-12">
