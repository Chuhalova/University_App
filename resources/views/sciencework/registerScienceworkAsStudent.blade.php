...
<body>
  ...
  <a href="javascript:void(0);" class="icon" onclick="myFunction()">
    <i class="fa fa-bars"></i>
        ...
        <main class="py-4">
            <div id='register-sw-as-student' class="container">
                        ...
                        <div class="shopper-info">
                            <div class="col-sm-12">
                                ...
                                <div class="contact-form">
                                    ...
                                    <form id="main-contact-form" class="contact-form row" id='sub' method="POST" action="{{ route('add-sciencework-as-student') }}">
                                        @csrf
                                        <div class="form-group col-md-12">
                                            <label for="topic">{{ __('Тема роботи') }}</label>
                                            <input placeholder="Тема роботи" id="topic" class="form-control" type="text" name="topic" value="{{ old('topic') }}" required autocomplete="topic" autofocus>
                                        </div>
                                        <div class="form-group col-md-12">
                                        ...
                                        <button style="margin:auto" type="submit" class="btn-in-form btn btn-primary">
                                            {{ __('Надіслати') }}
                                        </button>
                                    </form>
                                </div>
