@extends('layouts.app')
@section('content')
<div id='edit-cathedraworker-cont' class="container">
            ...
            <div class="shopper-info">
                <div class="col-sm-12">
                    ...
                    <div class="contact-form">
                        <h2 class="title text-center">Відредагувати заявку на роботу</h2>
                        <div class="status alert alert-success" style="display: none"></div>
                        <form  action="{{url('/cathedraworker/update/'.$sw->id) }}" method='POST'>
                            {{method_field('PATCH')}}
                            @csrf
